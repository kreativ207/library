			...
			<table class="table table-striped table-bordered table-condensed" id="<?=$modelName?>-table">
				<thead>
					<tr>
						...
						<th data-sort="<?=$tableName?>.author"><a href="#" onclick="return false;"><?=$searchModel->getAttributeLabel('author')?></a></th>
						<th data-sort="<?=$tableName?>">Count Books</th>
					...
					<tr class="filters">
						...
						<td><input type="text" name="<?=$searchModelName?>[author]" class="form-control search-on-change"></td>
						<td></td>
					</tr>
				</thead>
				<tbody>
